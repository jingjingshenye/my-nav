...
const I18N = {
  'zh-tw': {
    ...
    '语言': '語言', '语言选择': '語言選擇', '视图': '檢視', '翻页按钮': '翻頁按鈕', '行数': '行數', '列数': '列數', '间距': '間距', '松手合并为文件夹': '鬆手合併為資料夾', '松手移入文件夹': '鬆手移入資料夾', '松手合并文件夹': '鬆手合併資料夾', '已移出到桌面': '已移出到桌面', '已合并文件夹': '已合併資料夾',
  ...
  en: {
    ...
    '语言': 'Language', '语言选择': 'Language', '视图': 'View', '翻页按钮': 'Page buttons', '行数': 'Rows', '列数': 'Columns', '间距': 'Spacing', '松手合并为文件夹': 'Release to create folder', '松手移入文件夹': 'Release to move into folder', '松手合并文件夹': 'Release to merge folders', '已移出到桌面': 'Moved out to desktop', '已合并文件夹': 'Folders merged',
