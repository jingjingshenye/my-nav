...
const I18N = {
  'zh-tw': {
    ...
    '语言': '語言', '语言选择': '語言選擇', '视图': '檢視', '翻页按钮': '翻頁按鈕', '行数': '行數', '列数': '列數', '间距': '間距', '松手合并为文件夹': '鬆手合併為資料夾', '松手移入文件夹': '鬆手移入資料夾', '松手合并文件夹': '鬆手合併資料夾', '已移出到桌面': '已移出到桌面', '已合并文件夹': '已合併資料夾', '拖到浮层外移出 · 点标题重命名': '拖到浮層外移出 · 點標題重新命名',
