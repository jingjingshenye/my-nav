...
- **设置面板（对齐 inftab，全部实时生效）**：目标打开方式（网站/搜索是否新标签打开）、视图（屏幕缩放、右下角随机壁纸按钮、翻页按钮）、布局预设（自动/2x4~2x7/3x3/自定义行列）、图标（隐藏名称、阴影、启动动画、圆角/不透明度/大小滑杆）、搜索框（隐藏、搜索建议、保留内容、隐藏类别、大小/圆角/不透明度）、字体（阴影、大小、颜色色板含彩色）、重置设置（保留网址与云同步配置）。
